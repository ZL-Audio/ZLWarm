...
public:
    ...
    void setShapes(FloatType curve) {
        shaperMixer.setShapes(curve);
    }

    void setWarm(FloatType value) {
        shaperMixer.setWarm(value);
    }
...
public:
    ...
    void setShape(FloatType curve) {
        helper.setShapes(curve);
    }

    void setWarm(FloatType value) {
        helper.setWarm(value);
    }
...
public:
    ...
    void addListeners() {
        std::array IDs{zldsp::effectIn::ID, zldsp::wet::ID, zldsp::curve::ID,
                       zldsp::bandSplit::ID, zldsp::lowSplit::ID, zldsp::highSplit::ID,
                       zldsp::overSample::ID, zldsp::warm::ID};
        for (auto &ID: IDs) {
    ...
    void parameterChanged(const juce::String &parameterID, float newValue) override {
        ...
        } else if (parameterID == zldsp::curve::ID) {
            waveShaper->setShape(static_cast<FloatType>(zldsp::curve::formatV(newValue)));
        } else if (parameterID == zldsp::warm::ID) {
            waveShaper->setWarm(static_cast<FloatType>(zldsp::warm::formatV(newValue)));
